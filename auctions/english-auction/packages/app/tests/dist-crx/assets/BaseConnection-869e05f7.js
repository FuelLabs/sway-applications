...
const ji = {
  ...
  {
    VITE_MNEMONIC_WORDS: Xo,
    VITE_FUEL_PROVIDER_URL: Jo,
    VITE_FAUCET_RECAPTCHA_KEY: Qo,
    VITE_FUEL_FAUCET_URL: Zo,
    VITE_ADDR_OWNER: eu,
    VITE_CRX: tu,
    NODE_ENV: nu,
  } = {
  ...
  ou = 600,
  uu = 30,
  Ui = typeof chrome < 'u' && typeof chrome.runtime < 'u',
  su = 'isLogged',
  cu = Ui && globalThis.location.pathname === Xn.popup,
...
function An(e) {
  ...
  } else if (qi.indexOf(e.constructor) >= 0) t = e;
  else {
    var i = Et(e);
...
var er = Zn.reduce(function (e, t) {
 ...
 ` + a
          ...
          : ((this.message = Qi[t] || n), (this.inner = null));
    }
...
typeof Symbol < 'u' && Symbol.toStringTag && De(O.prototype, Symbol.toStringTag, 'Dexie.Promise');
at.env = ei();
...
ot(O, {
  all: function () {
    var e = ke.apply(null, arguments).map(Qt);
    return new O(function (t, n) {
      e.length === 0 && t([]);
      var r = e.length;
      e.forEach(function (i, a) {
        return O.resolve(i).then(function (o) {
          (e[a] = o), --r || t(e);
        }, n);
      });
    });
    ...
    t(function (n) {
      if (e._state === null) {
        ...
        n && typeof n.then == 'function'
          ? Xr(e, function (i, a) {
              n instanceof O ? n._then(i, a) : n.then(i, a);
            })
      ...
      Ee &&
        ...
        Hi(function () {
          ...
          (t._promise = e),
            De(t, 'stack', {
              get: function () {
                return On ? r && (r.get ? r.get.apply(t) : r.value) : e.stack;
              },
            });
        }),
      fa(e),
...
function ca(e, t, n) {
  try {
    ...
    var r,
      i = t._value;
    t._state ? (r = e(i)) : (Vt.length && (Vt = []), (r = e(i)), Vt.indexOf(i) === -1 && da(t)),
      n.resolve(r);
  } catch (a) {
    n.reject(a);
  } finally {
...
function je(e, t, n, r) {
  var i = K,
    a = Object.create(i);
  (a.parent = i), (a.ref = 0), (a.global = !1), (a.id = ++va);
  var o = at.env;
  (a.env = rr
    ? {
        Promise: O,
...
function ct() {
  return ie.id || (ie.id = ++ha), ++ie.awaits, (ie.echoes += qr), ie.id;
}
function Pe() {
...
function Nt(e) {
  return typeof e == 'string' && !/\./.test(e)
    ? function (t) {
        return t[e] === void 0 && e in t && ((t = kt(t)), delete t[e]), t;
      }
    : function (t) {
        return t;
      };
    ...
    (e.prototype.add = function (t, n) {
      ...
      return (
        ...
        this._trans('readwrite', function (s) {
          ...
          .then(function (s) {
            return s.numFailures ? O.reject(s.failures[0]) : s.lastResult;
          })
          .then(function (s) {
            if (o)
              try {
...
function _a(e) {
  return Kt(wa.prototype, function (n, r, i) {
    (this.db = e),
      (this._tx = i),
      (this.name = n),
      (this.schema = r),
      (this.hook = e._allTables[n]
        ? e._allTables[n].hook
        : Pt(null, { creating: [na, G], reading: [ta, Ot], updating: [ia, G], deleting: [ra, G] }));
  });
}
function tt(e, t) {
...
var Aa = (function () {
    ...
    return (
            ...
            .then(function (E) {
              var S = function (w) {
                ...
                return s
                  ...
                  .then(function (y) {
                    for (var A = [], D = [], T = d ? [] : null, I = [], C = 0; C < b; ++C) {
                      var M = y[C],
                        U = { value: kt(M), primKey: E[w + C] };
                      a.call(U, U.value, U) !== !1 &&
                        (U.value == null
                          ? I.push(E[w + C])
                          : !d && ue(l(M), l(U.value)) !== 0
                          ? (I.push(E[w + C]), A.push(U.value))
                          : (D.push(U.value), d && T.push(E[w + C])));
                    }
                    var j = tt(r) &&
                      r.limit === 1 / 0 &&
      ...
      (e.prototype.delete = function () {
        var t = this._ctx,
          n = t.range;
        return tt(t) && ((t.isPrimKey && !ga) || n.type === 3)
...
function Ta(e) {
  return Kt(Aa.prototype, function (n, r) {
    this.db = e;
    var i = ii,
      a = null;
    if (r)
    ...
    (e.prototype.inAnyRange = function (t, n) {
      ...
      return (
        (b._ondirectionchange = function (y) {
          y === 'next' ? ((w = g), (h = a)) : ((w = E), (h = o)), p.sort(_);
        }),
...
function Pa(e) {
  return Kt(Da.prototype, function (n, r, i, a, o) {
    var u = this;
    (this.db = e),
      (this.mode = n),
      (this.storeNames = r),
      ...
      (this._spinCount = 0),
      (this._completion = new O(function (s, c) {
    ...
    function p(g) {
      ...
      return new Promise(function (A, D) {
        ...
        var T = w.index,
          I = w.range,
          C = E.objectStore(h),
          M = T.isPrimaryKey ? C : C.index(T.name),
      ...
      getMany: function (g) {
        ...
        return new Promise(function (w, b) {
          ...
          for (
            ...
            var Q = S[j];
            Q != null && ((C = y.get(S[j])), (C._pos = j), (C.onsuccess = M), (C.onerror = U), ++T);
          }
          T === 0 && w(D);
        });
      },
      ...
      count: function (g) {
        ...
        return new Promise(function (y, A) {
          var D = S.objectStore(h),
            ...
            I = i(b),
            C = I ? T.count(I) : T.count();
          (C.onsuccess = Z(function (M) {
...
function ja(e, t, n, r) {
  var i = n.IDBKeyRange;
  n.indexedDB;
  var a = Fa(Na(t, i, r), e.dbcore);
  return { dbcore: a };
}
function or(e, t) {
  var n = e._novip,
    r = t.db,
    i = ja(n._middlewares, r, n._deps, t);
  (n.core = i.dbcore),
...
function Va(e, t, n, r) {
    ...
    a.push(function () {
      ...
      if (v && l._cfg.version > t) {
        ...
        p.del.forEach(function (b) {
          ...
          en(i, [i.Transaction.prototype], te(g), g),
          (n.schema = g);
        var E = Qn(v);
        E && ct();
        var S,
  ...
  function d() {
    return a.length ? O.resolve(a.shift()(n.idbtrans)).then(d) : O.resolve();
  }
...
function za(e) {
  return Kt(Ga.prototype, function (n) {
    (this.db = e),
      (this._cfg = {
        version: n,
        storesSource: null,
...
function eo(e) {
  ...
  return O.race([
    r,
    (typeof navigator > 'u' ? O.resolve() : Za()).then(function () {
      return new O(function (s, c) {
        ...
        (l.onerror = be(c)),
          ...
          (l.onupgradeneeded = Z(function (h) {
            if (((o = l.transaction), t.autoSchema && !e._options.allowEmptyDB)) {
              ...
              (u = p < 1), (e._novip.idbdb = l.result), La(e, p / 10, o, c);
            }
          }, c)),
          (l.onsuccess = Z(function () {
            ...
            if (_.length > 0)
              try {
                var p = h.transaction(Ka(_), 'readonly');
                t.autoSchema
                  ? $a(e, h, p)
                  : (Vn(e, e._dbSchema, p),
                    Ya(e, p) ||
    ...
    table: function (t) {
      ...
      function h(v, g) {
        return {
          ...
          lower: Ut(v.lower, v.lowerOpen ? e.MAX_KEY : e.MIN_KEY, g),
          lowerOpen: !0,
          upper: Ut(v.upper, v.upperOpen ? e.MIN_KEY : e.MAX_KEY, g),
          upperOpen: !0,
        };
      }
      function _(v) {
...
var ro = { stack: 'dbcore', name: 'VirtualIndexMiddleware', level: 1, create: no };
function fr(e, t, n, r) {
  return (
    (n = n || {}),
    (r = r || ''),
          ...
          i = H(H({}, n), {
            mutate: function (a) {
              ...
              function l(p) {
                ...
                return (
                  (p = p.type === 'add' || p.type === 'put' ? H(H({}, p), { keys: g }) : H({}, p)),
                  p.type !== 'delete' && (p.values = Sn([], p.values, !0)),
                  p.keys && (p.keys = Sn([], p.keys, !0)),
                  oo(n, p, g).then(function (E) {
                    var S = g.map(function (w, b) {
                      var y = E[b],
                      ...
                      .then(function (w) {
                        for (
                          ...
                          var I = y ? y[T] : g[T],
                            C = S[T];
                          I == null
                            ? C.onerror && C.onerror(b[T])
                            : C.onsuccess &&
                              C.onsuccess(p.type === 'put' && E[T] ? p.values[T] : I);
                        }
              ...
              function _(p, v, g) {
                return n
                  .query({ trans: p, values: !1, query: { index: r, range: v }, limit: g })
                  .then(function (E) {
                    var S = E.result;
                    return l({ type: 'delete', keys: S, trans: p }).then(function (w) {
                      return w.numFailures > 0
                        ...
                        : _(p, H(H({}, v), { lower: S[S.length - 1], lowerOpen: !0 }), g);
                    });
                  });
              }
            },
...
function fi(e, t, n) {
  try {
    ...
    for (var r = [], i = 0, a = 0; i < t.keys.length && a < e.length; ++i)
      ue(t.keys[i], e[a]) === 0 && (r.push(n ? kt(t.values[i]) : t.values[i]), ++a);
            ...
            getMany: function (r) {
              ...
              return i
                ...
                : n.getMany(r).then(function (a) {
                    return (
                      (r.trans._cache = { keys: r.keys, values: r.cache === 'clone' ? kt(a) : a }),
                      a
                    );
                  });
            },
...
function Ct(e, t, n) {
  ...
  if (!isNaN(r)) {
    ...
    var i = e.l,
      a = e.r;
    if (ue(n, e.from) < 0)
      return i ? Ct(i, t, n) : (e.l = { from: t, to: n, d: 1, l: null, r: null }), Cr(e);
    if (ue(t, e.to) > 0)
      return a ? Ct(a, t, n) : (e.r = { from: t, to: n, d: 1, l: null, r: null }), Cr(e);
...
function Cr(e) {
  ...
  if (i) {
    var a = i === 'r' ? 'l' : 'r',
      o = H({}, e),
      u = e[i];
    (e.from = u.from), (e.to = u.to), (e[i] = u[i]), (o[i] = u[a]), (e[a] = o), (o.d = kr(o));
  }
  e.d = kr(e);
}
function kr(e) {
          ...
          c = H(H({}, i), {
            mutate: function (h) {
              ...
              return i.mutate(h).then(function (D) {
                if (ae(b)) {
                  S !== 'delete' && (b = D.results), g.addKeys(b);
                  var T = fi(b, A);
                  !T && S !== 'add' && E.addKeys(b), (T || y) && lo(v, a, T, y);
                } else if (b) {
                ...
                if ((v(w.name || '').add(b), !w.isPrimaryKey))
                  if (h === 'count') E.add(n);
                    ...
                    return i[h].apply(this, arguments).then(function (A) {
                      if (h === 'query') {
                        if (s && _.values)
                          return y.then(function (C) {
                            var M = C.result;
                            return g.addKeys(M), A;
                          });
                        ...
                        return (
                          ...
                          Object.create(T, {
                            ...
                            value: {
                              get: function () {
                                return I && g.addKey(T.primaryKey), T.value;
                              },
                            },
                          })
                        );
...
var L = (function () {
    function e(t, n) {
      ...
      (o.dbReadyPromise = new O(function (u) {
        o.dbReadyResolve = u;
      })),
        (o.openCanceller = new O(function (u, s) {
          o.cancelOpen = s;
        })),
        (this._state = o),
        (this.name = t),
        ...
        (this.on.ready.subscribe = Nr(this.on.ready.subscribe, function (u) {
          return function (s, c) {
            e.vip(function () {
              var d = r._state;
              if (d.openComplete) d.dbOpenError || O.resolve().then(s), c && u(s);
        ...
        (this.Collection = Ta(this)),
        (this.Table = _a(this)),
        (this.Transaction = Pa(this)),
        (this.Version = za(this)),
        (this.WhereClause = Ra(this)),
  ...
  fo = typeof Symbol < 'u' && 'observable' in Symbol ? Symbol.observable : '@@observable',
  ho = (function () {
    function e(t) {
      this._subscribe = t;
    }
...
ot(
  ...
  H(H({}, an), {
    ...
    getDatabaseNames: function (e) {
      try {
        return Xa(Ye.dependencies).then(e);
      } catch {
    ...
    waitFor: function (e, t) {
      var n = O.resolve(typeof e == 'function' ? Ye.ignoreTransaction(e) : e).timeout(t || 6e4);
...
if (typeof BroadcastChannel < 'u') {
  var Or = new BroadcastChannel(Fe);
  Le(It, function (e) {
    Oe || Or.postMessage(e);
  }),
    (Or.onmessage = function (e) {
      e.data && nn(e.data);
    });
  ...
  Rr && Rr.addEventListener('message', po);
}
function po(e) {
  var t = e.data;
  t && t.type === Fe && nn(t.changedParts);
}
O.rejectionMapper = ea;
Wr(Ee, ri);
function hi() {}
function yo(e, t) {
  return e === hi
...
function Ao(e, t) {
  return function (r, i, a, o) {
    ...
    if (s) {
      var _ = { source: o.source || null, table: t, key: i, type: bo, mods: u, oldObj: a, obj: c },
        p = e._changes.add(_);
...
function To(e, t) {
  return function (r, i, a) {
    var o = e._changes
      .add({ source: a.source || null, table: t, key: r, type: Eo, oldObj: i })
      .then(function (u) {
...
function Io(e) {
  return function (n) {
    if (!n.hook._observing) {
      n.hook._observing = !0;
      var r = n.name;
      n.hook('creating').subscribe(So(e, n)),
        n.hook('updating').subscribe(Ao(e, r)),
        n.hook('deleting').subscribe(To(e, r));
    }
  };
}
function xo(e) {
            ...
            return (
              h.wantReply &&
                (E = new ht(function (S, w) {
                  a[g.toString()] = { resolve: S, reject: w };
                })),
              i && i.setItem('Dexie.Observable/intercomm/' + e.name, g.toString()),
...
function V(e) {
  ...
  L.fake &&
    ...
    (e.Version.prototype._parseStoresSpec = vt(e.Version.prototype._parseStoresSpec, Oo)),
    e.on.addEventType({ changes: 'asap', cleanup: [yo, hi], message: 'asap' }),
    ...
    (e.delete = vt(e.delete, function (I) {
      return function () {
        return I.apply(this, arguments).then(function (C) {
          return (V.latestRevision[e.name] = 0), C;
        });
      };
    })),
    e.on(
  ...
  function w(I, C, M) {
    if (!C && w.ongoingOperation) return w.ongoingOperation;
    var U = !1,
      j = l.node;
      ...
      P = e._changes
        ...
        .then(function (Y) {
          ...
          if (U || V.latestRevision[e.name] > j.myRevision)
            return w(V.latestRevision[e.name], (C || 0) + 1, U);
        })
        .finally(function () {
          delete w.ongoingOperation;
        });
    return C || (w.ongoingOperation = P), P;
  }
  function b() {
    g = null;
    ...
    I &&
      e
        .transaction('rw!', e._syncNodes, function () {
          e._syncNodes.where({ id: I }).first(function (C) {
            if (!C) {
              e.isOpen() && e.close();
              return;
            }
            return (C.lastHeartBeat = Date.now()), (C.deleteTimeStamp = null), e._syncNodes.put(C);
          });
        })
        .catch('DatabaseClosedError', function () {})
        .finally(function () {
          l.node && l.node.id === I && e.isOpen() && (g = setTimeout(b, i));
        });
  }
  function y() {
    v = null;
    ...
    return I
      ? e.transaction('rw', '_syncNodes', '_changes', '_intercomm', function () {
          ...
          e._syncNodes
            ...
            .modify(function (M) {
              M.deleteTimeStamp && M.deleteTimeStamp < Date.now()
                ? (delete this.value,
                  ...
                  M.isMaster && (e._syncNodes.update(I, { isMaster: 1 }), (C = !0)),
            ...
            .then(function () {
              return V.deleteOldChanges(e), e.on('cleanup').fire(C);
            });
        })
  ...
  function T(I, C) {
    I === e.name &&
      !V.wereTheOneDying &&
      L.vip(function () {
        e._syncNodes.update(C, { deleteTimeStamp: 1, lastHeartBeat: 0 }).then(A);
      });
  }
}
V.version = '{version}';
...
function Bo(e, ...t) {
  const n = e != null,
    r = e?.[0] === '/' && e.length > 1,
    i = [e, ...t].filter(Boolean).map(Mo);
  return r && n && i.unshift(''), i.join(Po);
}
function gn(e) {
  return Bo('/', e);
}
...
var Fo = '.',
  ...
  Uo = 'xstate.guard',
  Lo = '';
ft.DEFAULT_GUARD_TYPE = Uo;
ft.EMPTY_ACTIVITY_MAP = jo;
ft.STATE_DELIMITER = Fo;
ft.TARGETLESS_KEY = Lo;
var hr = {};
...
(function (e) {
  ...
  function o(f, x, R) {
    ...
    return Y(B)
      ...
      : Y(k)
      ? k in B
      : Object.keys(k).every(function (F) {
          return F in B ? o(k[F], B[F]) : !1;
        });
  }
  function u(f) {
    try {
  ...
  function h(f) {
    ...
    for (var x = {}, R = x, k = 0; k < f.length - 1; k++)
      k === f.length - 2 ? (R[f[k]] = f[k + 1]) : ((R[f[k]] = {}), (R = R[f[k]]));
    return x;
  }
  function _(f, x) {
    for (var R = {}, k = Object.keys(f), B = 0; B < k.length; B++) {
      var F = k[B];
      R[F] = x(f[F], F, f, B);
    }
    return R;
  ...
  function E(f) {
    ...
    var x = w(
      Object.keys(f).map(function (R) {
        var k = f[R];
        return typeof k != 'string' && (!k || !Object.keys(k).length)
          ? [[R]]
  ...
  function S(f) {
    ...
    try {
      for (var B = t.__values(f), F = B.next(); !F.done; F = B.next())
        for (var $ = F.value, W = k, z = 0; z < $.length; z++) {
          var ee = $[z];
          if (z === $.length - 2) {
            W[ee] = $[z + 1];
            break;
  ...
  function M(f, x) {
    return _(f.states, function (R, k) {
      if (R) {
        var B = (Y(x) ? void 0 : x[k]) || (R ? R.current : void 0);
    ...
    r.IS_PRODUCTION ||
      (e.warn = function (f, x) {
        ...
        if (!(!R && f) && console !== void 0) {
          var k = ['Warning: '.concat(x)];
          R && k.push(R), console.warn.apply(console, k);
        }
      });
  function Q(f) {
  ...
  function sn(f, x) {
    var R = b(x).map(function (k) {
      return typeof k > 'u' || typeof k == 'string' || ye(k)
        ? { target: k, event: f }
        : t.__assign(t.__assign({}, k), { event: f });
    });
    return R;
  }
  function Ii(f) {
  ...
  function xi(f, x, R) {
    if (!r.IS_PRODUCTION) {
      var k = f.stack ? " Stacktrace was '".concat(f.stack, "'") : '';
      if (f === x)
        console.error(
  ...
  function Ci(f, x, R, k, B) {
    var F = f.options.guards,
      $ = { state: B, cond: x, _event: k };
    if (x.type === n.DEFAULT_GUARD_TYPE) return (F?.[x.name] || x.predicate)(R, k.data, $);
    var W = F?.[x.type];
    if (!W)
      throw new Error(
  ...
  function Oi(f, x, R) {
    var k = function () {},
      ...
      F = B ? f : null;
    return {
      next: ((B ? f.next : f) || k).bind(F),
      error: ((B ? f.error : x) || k).bind(F),
      complete: ((B ? f.complete : R) || k).bind(F),
    };
  }
  function Ri(f, x) {
...
class xe {
  static getNetworks() {
    return m.transaction('r', m.networks, async () => m.networks.toArray());
  }
  static getNetwork(t) {
    return m.transaction('r', m.networks, async () => m.networks.get({ id: t.id }));
  }
  static addNetwork(t) {
    return m.transaction('rw', m.networks, async () => {
      const n = await m.networks.count(),
        r = await m.networks.add({
          ...t.data,
          ...(n === 0 && { isSelected: !0 }),
          id: gi.uniqueId(),
        });
      return m.networks.get(r);
    });
  }
  static updateNetwork(t) {
    ...
    return m.transaction(
      'rw',
      m.networks,
      async () => (await m.networks.update(t.id, t.data), m.networks.get(t.id))
    );
  }
  static removeNetwork(t) {
    return m.transaction('rw', m.networks, async () => {
      ...
      return await m.networks.where(t).delete(), r?.id;
    });
  }
  static getSelectedNetwork() {
    return m.transaction('r', m.networks, async () =>
      (await m.networks.toArray()).find((t) => t.isSelected)
    );
  }
  static selectNetwork(t) {
    return m.transaction('rw', m.networks, async () => {
      const n = await m.networks.filter((r) => Boolean(r.isSelected)).first();
      return (
  ...
  static clearNetworks() {
    return m.transaction('rw', m.networks, async () => m.networks.clear());
  }
  ...
  wi = class {
    ...
    getAccounts() {
      let e = [],
        t = 0;
      do {
        let n = Ce.fromMnemonic(X(this, He), this.getDerivePath(t));
    ...
    addAccount() {
      ...
      let e = Ce.fromMnemonic(X(this, He), this.getDerivePath(this.numberOfAccounts - 1));
  ...
  _i = class {
    constructor(e) {
      qe(this, Me, []),
        e.secret
          ? me(this, Me, [e.secret])
          : me(this, Me, e.accounts || [Ce.generate().privateKey]);
    }
    serialize() {
      return { accounts: X(this, Me) };
    }
    getPublicAccount(e) {
      let t = Ce.fromPrivateKey(e);
    ...
    exportAccount(e) {
      let t = X(this, Me).find((n) => Ce.fromPrivateKey(n).address.equals(e));
...
class $o {
  async getItem(t) {
    return m.transaction('r', m.vaults, async () => (await m.vaults.get({ key: t }))?.data);
  }
  async setItem(t, n) {
    await m.transaction('rw', m.vaults, m.accounts, async () => {
      await m.vaults.put({ key: t, data: n });
    });
  }
  async removeItem(t) {
    await m.transaction('rw', m.vaults, m.accounts, async () => {
      await m.vaults.where({ key: t }).delete();
    });
  }
  async clear() {
    await m.transaction('rw', m.vaults, m.accounts, async () => {
      await m.vaults.clear(), await m.accounts.clear();
    });
  }
}
async function pt(e) {
...
class qt {
  static async addAccount(t) {
    return m.transaction('rw', m.accounts, async () => {
      const n = await m.accounts.count(),
        r = { ...t.data, isCurrent: n === 0, isHidden: !!t.data.isHidden };
      return await m.accounts.add(r), m.accounts.get({ address: t.data.address });
    });
  }
  static async getAccounts() {
    return m.transaction('r', m.accounts, async () => m.accounts.toCollection().sortBy('name'));
  }
  static async clearAccounts() {
    return m.transaction('rw', m.accounts, async () => m.accounts.clear());
  }
  static async fetchAccount(t) {
    const { address: n } = t,
      r = await m.transaction('r', m.accounts, async () => m.accounts.get({ address: n }));
  ...
  static async fetchBalance(t) {
    ...
    try {
      const i = await qo(r, n.publicKey),
        o = i.find(Yo)?.amount;
      return (
        (await qt.setBalance({
          data: {
  ...
  static async setBalance(t) {
    if (m.isOpen())
      return m.transaction('rw!', m.accounts, async () => {
        ...
        return await m.accounts.update(n, r), m.accounts.get({ address: t.data.address });
      });
  }
  ...
  static async createManager({ data: t }) {
    ...
    await m.vaults.clear();
    try {
      const n = await pt(t.password);
      return await n.addVault({ type: 'mnemonic', secret: No(t.mnemonic) }), n;
    } catch (n) {
  ...
  static getCurrentAccount() {
    return m.transaction('r', m.accounts, async () =>
      (await m.accounts.toArray()).find((t) => t.isCurrent)
    );
  }
  static setCurrentAccount(t) {
    return m.transaction(
      ...
      m.accounts,
      async () => (
        await m.accounts.filter((n) => !!n.isCurrent).modify({ isCurrent: !1 }),
        await m.accounts.update(t.address, { isCurrent: !0 }),
        m.accounts.get(t.address)
      )
    );
  }
  static updateAccount(t) {
    ...
    return m.transaction(
      'rw',
      m.accounts,
      async () => (await m.accounts.update(t.address, t.data), m.accounts.get(t.address))
    );
  }
  ...
  static async logout() {
    await m.close(), await L.delete('FuelDB'), await mi.clear(), await m.open();
  }
}
async function qo(e, t = '0x00') {
  const n = new bn(e),
...
class pu {
  static async addConnection(t) {
    return m.transaction(
      'rw',
      m.connections,
      async () => (await m.connections.add(t.data), m.connections.get({ origin: t.data.origin }))
    );
  }
  static async removeConnection({ origin: t }) {
    return m.transaction('rw', m.connections, async () => {
      const n = await m.connections.get({ origin: t });
      return await m.connections.delete(t), n;
    });
  }
  static async getConnection(t) {
    return m.transaction('r', m.connections, async () => m.connections.get({ origin: t }));
  }
  static async clearConnections() {
    return m.transaction('rw', m.connections, async () => m.connections.clear());
  }
  static async getConnections() {
    return m.transaction('r', m.connections, async () => m.connections.toArray());
  }
  ...
  static async removeAccountFrom(t) {
    ...
    return m.transaction('rw', m.connections, async () => {
      const i = await m.connections.get({ origin: n });
      return i && ((i.accounts = i.accounts.filter((a) => a !== r)), await m.connections.put(i)), i;
    });
  }
  static async addAccountTo(t) {
    ...
    return m.transaction('rw', m.connections, async () => {
      const i = await m.connections.get({ origin: n });
      return i && ((i.accounts = i.accounts.concat(r)), await m.connections.put(i)), i;
    });
  }
