...
# Project Structure
The project consists of a predicate written in Sway (`./project/predicates/swap-predicate/src/main.sw`) and tests using fuels-rs (`./project/predicates/swap-predicate/tests/`)
