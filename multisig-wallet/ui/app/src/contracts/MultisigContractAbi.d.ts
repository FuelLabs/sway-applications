...
export type ExecutionErrorInput = Enum<{
...
export type ExecutedEventInput = {
  data: string;
  nonce: BigNumberish;
  to: IdentityInput;
  value: BigNumberish;
};
export type ExecutedEventOutput = {
  data: string;
  nonce: BN;
  to: IdentityOutput;
  value: BN;
};
export type SetThresholdEventInput = {
  previous_threshold: BigNumberish;
...
export type SignatureInfoInput = {
  message_format: MessageFormatInput;
  message_prefix: MessagePrefixInput;
  signature: B512Input;
  wallet_type: WalletTypeInput;
};
export type SignatureInfoOutput = {
  message_format: MessageFormatOutput;
  message_prefix: MessagePrefixOutput;
  signature: B512Output;
  wallet_type: WalletTypeOutput;
};
