...
export enum GameStateErrorInput {
  GameHasEnded = 'GameHasEnded',
  GameHasNotEnded = 'GameHasNotEnded',
}
export enum GameStateErrorOutput {
  GameHasEnded = 'GameHasEnded',
  GameHasNotEnded = 'GameHasNotEnded',
}
...
export enum PlayerErrorInput {
  IncorrectPlayerTurn = 'IncorrectPlayerTurn',
}
export enum PlayerErrorOutput {
  IncorrectPlayerTurn = 'IncorrectPlayerTurn',
}
export enum PositionErrorInput {
  CellIsNotEmpty = 'CellIsNotEmpty',
  InvalidPosition = 'InvalidPosition',
}
export enum PositionErrorOutput {
  CellIsNotEmpty = 'CellIsNotEmpty',
  InvalidPosition = 'InvalidPosition',
}
export enum StateInput {
  Playing = 'Playing',
  Ended = 'Ended',
}
export enum StateOutput {
  Playing = 'Playing',
  Ended = 'Ended',
}
...
export type GameDrawnEventInput = {
  player_one: IdentityInput;
  player_two: IdentityInput;
};
export type GameDrawnEventOutput = {
  player_one: IdentityOutput;
  player_two: IdentityOutput;
};
export type GameWonEventInput = { player: IdentityInput };
export type GameWonEventOutput = { player: IdentityOutput };
export type NewGameEventInput = {
  player_one: IdentityInput;
  player_two: IdentityInput;
};
export type NewGameEventOutput = {
  player_one: IdentityOutput;
  player_two: IdentityOutput;
};
...
interface TictactoeContractAbiInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: 'get_current_player',
    values: []
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'get_game_state',
    values: []
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'get_move_counter',
    values: []
  ): Uint8Array;
  encodeFunctionData(functionFragment: 'get_players', values: []): Uint8Array;
  encodeFunctionData(
    functionFragment: 'make_move',
    values: [BigNumberish]
  ): Uint8Array;
  encodeFunctionData(
    functionFragment: 'new_game',
    values: [IdentityInput, IdentityInput]
  ): Uint8Array;

  decodeFunctionData(
    functionFragment: 'get_board',
    data: BytesLike
  ): DecodedValue;
  decodeFunctionData(
    functionFragment: 'get_current_player',
...
export class TictactoeContractAbi extends Contract {
  ...
  functions: {
    ...
    new_game: InvokeFunction<
      [player_one: IdentityInput, player_two: IdentityInput],
      void
    >;
  };
}
