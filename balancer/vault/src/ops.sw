...
pub fn binary_or(val: b256, other: b256) -> b256 {
    let(value_word_1, value_word_2, value_word_3, value_word_4) = decompose(val);
    let(other_word_1, other_word_2, other_word_3, other_word_4) = decompose(other);
...
pub fn lsh_u64(data: u64, other: u64) -> u64 {
    asm(r1: data, r2: other, r3) {
        sll r3 r1 r2;
        r3: u8
    }
}
...
pub fn lsh(value: b256, shift_amount: u64) -> b256 {
    let(word_1, word_2, word_3, word_4) = decompose(value);
    let mut w1 = 0;
    let mut w2 = 0;
    let mut w3 = 0;
    let mut w4 = 0;
