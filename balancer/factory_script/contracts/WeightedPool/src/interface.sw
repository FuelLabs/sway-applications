...
abi WeightedPool {
    ...
    #[storage(read, write)]fn query_join(poolId: b256, sender: ContractId, arecipient: ContractId, balances: Vec<u64>, lastChangeBlock: u64, protocolSwapFeePercentage: u64, userData: Vec<b256>) -> (u64, Vec<u64>);
    #[storage(read, write)]fn query_exit(poolId: b256, sender: ContractId, arecipient: ContractId, balances: Vec<u64>, lastChangeBlock: u64, protocolSwapFeePercentage: u64, userData: Vec<b256>) -> (u64, Vec<u64>);
