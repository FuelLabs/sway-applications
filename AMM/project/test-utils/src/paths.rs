...
pub const MALICIOUS_EXCHANGE_CONTRACT_BINARY_PATH: &str =
    "../../contracts/test-artifacts/malicious-implementation/out/debug/malicious-implementation.bin";
pub const MALICIOUS_EXCHANGE_CONTRACT_STORAGE_PATH: &str =
    "../../contracts/test-artifacts/malicious-implementation/out/debug/malicious-implementation-storage_slots.json";
