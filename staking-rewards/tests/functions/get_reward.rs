use crate::utils::{abi::get_reward, get_balance, setup, INITIAL_STAKE, ONE, REWARDS_ASSET};
...
async fn claim_reward() {
    ...
    let expected_reward_per_token: u64 = ((timestamp - inittimestamp) * 42 * ONE) / INITIAL_STAKE;
