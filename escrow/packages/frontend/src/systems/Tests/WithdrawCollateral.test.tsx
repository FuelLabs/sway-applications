...
describe("Withdraw collateral", () => {
    ...
    xit("should withdraw collateral", async () => {
        ...
        // TODO wait until after the deadline

        const withdrawCollateralBtn = await screen.findByLabelText(/Withdraw collateral/);
        expect(withdrawCollateralBtn).toBeInTheDocument();
        await user.click(withdrawCollateralBtn);
    });
});
